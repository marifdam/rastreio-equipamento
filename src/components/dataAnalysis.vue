<template>
  ...
  <div class="tabs">
    <v-card theme="light">
      <v-tabs v-model="tab" align-tabs="center" class="tabs">
        <v-tab :value="1">Histórico</v-tab>
        <v-tab :value="2">Informações</v-tab>
      </v-tabs>
    </v-card>
    <v-tabs-window v-model="tab" theme="ligth">
      <v-tabs-window-item :key="1" :value="1" theme="ligth">
        <v-card theme="ligth">
          <Historico></Historico>
        </v-card>
      </v-tabs-window-item>
...
export default defineComponent({
  components: { Header, Historico, infoAdicionais },
  setup() {
    onMounted(() => {
